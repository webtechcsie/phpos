<?php
$new = '<form action="" method="post" name="frmDocument" id="frmDocument" style="padding:0px 0px 0px 0px;">
<fieldset><legend>Document intrare</legend>

<table width="100%"  border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td width="23%"><strong>Numar document </strong></td>
    <td width="77%"><input name="txtNumarDocument" type="text" id="txtNumarDocument"></td>
  </tr>
  <tr>
    <td><strong>Data</strong></td>
    <td><input name="txtData" type="text" id="txtData">
