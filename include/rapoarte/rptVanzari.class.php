<?php
class RptVanzari extends Rapoarte
{
...
join `zile_economice` `ze` on((`ze`.`zi_economica_id` = `bonuri`.`zi_economica_id`))) 
where ze.data between '$dateStart' and '$dateStop'
group by `produse`.`denumire`, `categorii`.`denumire_categorie`
